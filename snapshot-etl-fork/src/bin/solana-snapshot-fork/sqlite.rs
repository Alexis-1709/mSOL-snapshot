...
use solana_snapshot_fork::{append_vec_iter, AppendVecIterator};
...
INSERT OR REPLACE INTO account (pubkey, data_len, owner, lamports, executable, rent_epoch)
    ...
    fn insert_token(&mut self, account: &StoredAccountMeta, token_account: &spl_token::state::Account) -> Result<()> {
